...
<link rel="stylesheet" href="emp_jobdetailedit.css">
</head>
<body>
		...
		<c:forEach items="${sessionScope.EmpDetailList}" var="i">
			<div class="job-item">
				...
				<div class="job">
					...
					<div class="Button-up">
						<a class="Delete" href="RegController?flag=deletespe">DELETE</a> <a
							class="Edit" href="RegController?flag=Editspe">EDIT</a>
				...
				<div class="company-details">
					...
					<div class="content">
						<a href="${i.companyWebsite}">${i.companyWebsite}</a>
					</div>
